...
\------------------------------------------------------------------------------------------------*/
    ...
    function drawIDtimeline() {
        ...
        if (this.config.id_characteristics) {
            ...
            this.clinicalTimelines.containers.IDdetails.selectAll('.ct-ID-detail').each(function(
                d
            ) {
                d3
                    .select(this)
...
\------------------------------------------------------------------------------------------------*/
    ...
    function updatePopulationDetails() {
        this.clinicalTimelines.containers.popCurrentFilters
            .classed('ct-hidden', this.populationDetails.nOutsideTimeRange)
            .html(
    ...
    function updateTable(reference_line) {
        ...
        reference_line.flattened_data.sort(function(a, b) {
            var groupOrder =
                _this.config.reference_table_sort === 'frequency'
                    ? b.group_n - a.group_n
            ...
            var lowerOrder =
                _this.config.reference_table_sort === 'frequency'
                    ? b.n - a.n
                    : _this.config.reference_table_sort === 'event'
                      ? _this.config.color_dom.indexOf(a.key) -
                        _this.config.color_dom.indexOf(b.key)
                      : a.key < b.key ? -1 : 1;
