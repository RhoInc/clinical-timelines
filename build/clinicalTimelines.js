...
function groupingData() {
    ...
    //range_band hack
    if (this.config.grouping_direction === 'horizontal') this.config.range_band = this.initialSettings.range_band + this.groupings.length * 2 / d3$1.set(this.wide_data.filter(function (d) {
        var filtered = false;
