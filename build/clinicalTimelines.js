...
function defineStyles() {
    ...
    '#clinical-timelines .ct-column {' + '    display: inline-block;' + '}', '#clinical-timelines #ct-left-column {' + '    width: 22%;' + '    float: left;' + '}', '#clinical-timelines #ct-right-column {' + '    width: 75%;' + '    float: right;' + '}', '#clinical-timelines .ct-column > * {' + '    width: 100%;' + '    vertical-align: top;' + '    display: inline-block;' + '    margin-bottom: 10px;' + '    border: 1px solid #eee;' + '}',
    ...
    //Legend
    '#clinical-timelines #ct-right-column #timelines .wc-chart .legend {' + '    display: flex !important;' + '    justify-content: center;' + '}', '#clinical-timelines #ct-right-column #timelines .wc-chart .legend .legend-title {' + '    border-radius: 4px;' + '    padding: 5px 7px 3px 4px;' + '    border: 2px solid white;' + '    margin-right: .25em !important;' + '}', '#clinical-timelines #ct-right-column #timelines .wc-chart .legend .legend-item {' + '    cursor: pointer;' + '    float: left;' + '    border-radius: 4px;' + '    padding: 4px 7px 3px 4px;' + '    border: 2px solid white;' + '    margin-right: .25em !important;' + '}', '#clinical-timelines #ct-right-column #timelines .wc-chart .legend .legend-item .legend-color-block circle {' + '    cx: .55em !important;' + '    cy: .55em !important;' + '    r: .4em !important;' + '}', '#clinical-timelines #ct-right-column #timelines .wc-chart .legend .legend-item:hover {' + '    border: 2px solid black;' + '}',

    //Y-axis
    '#clinical-timelines #ct-right-column #timelines .wc-chart .wc-svg .y.axis .tick {' + '    cursor: pointer;' + '    fill: blue;' + '    text-decoration: none;' + '    font-weight: bolder;' + '}', '#clinical-timelines #ct-right-column #timelines .wc-chart .wc-svg .y.axis .tick:hover {' + '    text-decoration: underline;' + '}', '#clinical-timelines #ct-right-column #timelines .wc-chart .wc-svg .y.axis .tick rect.ct-stripe {' + '    stroke: #aaa;' + '    stroke-width: 1;' + '    fill: none;' + '}', '#clinical-timelines #ct-right-column #timelines .wc-chart .wc-svg .y.axis .tick:nth-child(even) rect.ct-stripe {' + '    fill: #eee;' + '}',

    //Grouping
    '#clinical-timelines #ct-right-column #timelines .wc-chart .wc-svg .ct-grouping .ct-boundary {' + '    stroke: black;' + '    stroke-width: 2px;' + '}', '#clinical-timelines #ct-right-column #timelines .wc-chart .wc-svg .ct-grouping .ct-annotation {' + '    font-size: 150%;' + '    font-weight: normal;' + '    text-anchor: start;' + '}', '#clinical-timelines #ct-right-column #timelines .wc-chart .wc-svg .ct-grouping.ct-vertical .ct-annotation {' + '    writing-mode: tb-rl;' + '}',

    //Lines
    '#clinical-timelines path.wc-data-mark {' + '    stroke-width: 4;' + '    clip-path: url(#1);' + '    stroke-opacity: 1;' + '}', '#clinical-timelines path.wc-data-mark.ct-highlighted {' + '    stroke-width: 7;' + '}', '#clinical-timelines line.ct-highlight-overlay {' + '    clip-path: url(#1);' + '    stroke-width: 3;' + '    stroke-linecap: round;' + '}',

    //Circles
    '#clinical-timelines circle.wc-data-mark {' + '    stroke-width: 0;' + '    clip-path: url(#1);' + '    fill-opacity: 1;' + '}', '#clinical-timelines circle.wc-data-mark.ct-highlighted {' + '    stroke-opacity: 1;' + '    stroke-width: 2;' + '}',
    ...
    //Reference lines
    '#clinical-timelines #ct-right-column .wc-chart .wc-svg .ct-visible-reference-line {' + '    stroke: black;' + '    stroke-width: 2px;' + '    stroke-dasharray: 2,2;' + '}', '#clinical-timelines #ct-right-column .wc-chart .wc-svg .ct-visible-reference-line.ct-hover {' + '    stroke-dasharray: none;' + '}', '#clinical-timelines #ct-right-column .wc-chart .wc-svg .ct-invisible-reference-line {' + '    stroke: black;' + '    stroke-width: 20px;' + '    stroke-opacity: 0;' + '}', '#clinical-timelines #ct-right-column .wc-chart .wc-svg .ct-reference-line-label-box {' + '    fill: white;' + '    stroke: black;' + '    stroke-width: black;' + '}',

    //ID timeline
    '#clinical-timelines #ct-right-column #IDtimeline .wc-chart .wc-svg title {' + '    white-space: pre;' + '}', '#clinical-timelines #ct-right-column #IDtimeline .wc-small-multiples .wc-chart {' + '    width: 100%;' + '    padding: 0;' + '    border-top: 1px solid black;' + '}', '#clinical-timelines #ct-right-column #IDtimeline .wc-small-multiples .wc-chart > * {' + '    display: inline-block;' + '}', '#clinical-timelines #ct-right-column #IDtimeline .wc-small-multiples .wc-chart .wc-svg {' + '    float: left;' + '    width: 75%;' + '}', '#clinical-timelines #ct-right-column #IDtimeline .wc-small-multiples .wc-chart .wc-chart-title {' + '    float: right;' + '    text-align: left;' + '    font-size: 150%;' + '    font-weight: normal;' + '    padding-left: 10px;' + '    width: 24%;' + '}', '#clinical-timelines #ct-right-column #IDtimeline .wc-small-multiples .wc-chart .wc-svg .ct-time-range {' + '    opacity: .1;' + '}',

    //Listing
    '#clinical-timelines #ct-right-column #listing .wc-chart.wc-table table {' + '    display: table;' + '    width: 100%;' + '}'],
...
function defineLayout() {
    ...
    this.containers.populationDetails = this.containers.details.append('div').classed('ct-annotation', true).attr('id', 'population-details');

    //Add container for ID characteristics.
    this.containers.IDdetails = this.containers.details.append('div').classed('ct-annotation ct-hidden', true).attr('id', 'ID-details');

    //Add back button to return from ID timeline to clinical timelines.
    this.containers.backButton = this.containers.IDdetails.append('div').attr('id', 'back-button');
...
function controls$1() {
    this.controls = webcharts.createControls(this.containers.controls.node(), { location: 'top', inputs: this.settings.controls });
}
...
function manipulateData() {
    ...
    this.initial_data.forEach(function (d, i) {
        ...
        d.stdtdy = has_stdt && has_stdy ? d[_this.config.stdt_col] + ' (' + d[_this.config.stdy_col] + ')' : d[_this.config.stdt_col] || d[_this.config.stdy_col];
        d.endtdy = has_endt && has_endy ? d[_this.config.endt_col] + ' (' + d[_this.config.endy_col] + ')' : d[_this.config.endt_col] || d[_this.config.endy_col];
    });
}
...
function checkTimeScales() {
    ...
    this.controls.config.inputs = this.controls.config.inputs.filter(function (input) {
        if (input.description !== 'X-axis scale') return true;else {
            ...
            if (!anyDates && !anyDays) {
                var errorText = 'The data contain neither ' + _this.config.stdt_col + ' nor ' + _this.config.stdy_col + '.  Please update the settings object to match the variables in the data.';
...
function detailsLayout() {
    ...
    //Add back button to return from ID timeline to clinical timelines.
    this.clinicalTimelines.containers.backButton.append('button').html('&#8592; Back').on('click', function () {
...
function drawIDtimeline() {
    ...
    if (this.config.id_characteristics) this.IDdetails.wrap.selectAll('div.characteristic').each(function (d) {
        d3.select(this).select('span').text(wideIDdata[0][d.value_col]);
    });
...
function eventHighlightingChange(select, d) {
    ...
    this.config.event_highlighted = d3.select(select).select('option:checked').text();
...
function IDchange(select) {
    ...
    this.selected_id = d3.select(select).select('option:checked').text();
    this.filters.filter(function (filter) {
        return filter.col === _this.config.id_col;
...
function eventTypeChange(select) {
    ...
    this.currentEventTypes = d3.select(select).selectAll('select option:checked').pop().map(function (d) {
...
function definePopulationDetails() {
    ...
    this.populationDetails.sample = d3.set(this.filtered_wide_data.map(function (d) {
        ...
        IDobject.dataInsideTimeRange = IDobject.data.filter(function (d) {
            ...
            enInsideTimeRange = _this.config.x.domain[0] <= en && en <= _this.config.x.domain[1]; // end is within the time range
...
function drawTopXaxis() {
    var topXaxis = d3.svg.axis().scale(this.x).orient('top').tickFormat(this.config.x_d3format).innerTickSize(this.xAxis.innerTickSize()).outerTickSize(this.xAxis.outerTickSize()).ticks(this.xAxis.ticks()[0]),
        topXaxisSelection = this.svg.select('g.x-top.axis').attr('class', 'x-top axis linear');
    topXaxisSelection.call(topXaxis);
    topXaxisSelection.select('text.axis-title.top').attr('transform', 'translate(' + (this.raw_width / 2 - this.margin.left) + ',-' + 9 * this.config.margin.top / 16 + ')').text(this.config.x.label);
}
...
function offsetBottomXaxis() {
    var bottomXaxis = this.svg.select('.x.axis'),
        ...
        bottomXaxisTransformX = bottomXaxisTransform.indexOf(',') > -1 ? +bottomXaxisTransform.split(',')[0].split('(')[1] : +bottomXaxisTransform.split(' ')[0].split('(')[1],
        bottomXaxisTransformY = bottomXaxisTransform.indexOf(',') > -1 ? +bottomXaxisTransform.split(',')[1].split(')')[0] : +bottomXaxisTransform.split(' ')[1].split(')')[0],
        bottomXaxisTitle = bottomXaxis.select('.axis-title'),
        bottomXaxisTitleTransform = bottomXaxisTitle.attr('transform'),
        bottomXaxisTitleTransformX = bottomXaxisTitleTransform.indexOf(',') > -1 ? +bottomXaxisTitleTransform.split(',')[0].split('(')[1] : +bottomXaxisTitleTransform.split(' ')[0].split('(')[1],
        bottomXaxisTitleTransformY = bottomXaxisTitleTransform.indexOf(',') > -1 ? +bottomXaxisTitleTransform.split(',')[1].split(')')[0] : +bottomXaxisTitleTransform.split(' ')[1].split(')')[0];
    bottomXaxis.attr('transform', 'translate(0,' + (bottomXaxisTransformY + this.y.rangeBand()) + ')');
    bottomXaxisTitle.attr('transform', 'translate(' + bottomXaxisTitleTransformX + ',' + (bottomXaxisTitleTransformY - 7 * this.margin.bottom / 16) + ')');
}
...
function drawReferenceLines() {
    ...
    if (this.config.reference_lines) {
        ...
        this.config.reference_lines.filter(function (reference_line) {
            ...
            var referenceLineGroup = referenceLinesGroup.append('g').classed('ct-reference-line', true).attr('id', 'reference-line-' + i),
                ...
                visibleReferenceLine = referenceLineGroup.append('line').classed('ct-visible-reference-line', true).attr({
                x1: x,
                x2: x,
                y1: 0,
                y2: y2
            }),
                invisibleReferenceLine = referenceLineGroup.append('line').classed('ct-invisible-reference-line', true).attr({
                x1: x,
                x2: x,
                y1: 0,
                y2: y2
            ...
            direction = reference_line.timepoint <= (_this.x_dom[1] - _this.x_dom[0]) / 2 ? 'right' : 'left',
                referenceLineLabel = referenceLineGroup.append('text').classed('ct-reference-line-label', true).attr({
                x: x,
                y: 0,
                ...
                referenceLineLabelBox = referenceLineGroup.insert('rect', '.ct-reference-line-label').classed('ct-reference-line-label-box', true).attr({
                x: dimensions.x - 10,
                y: dimensions.y - 5,
