...
function syncSettings(settings) {
    ...
    if (!(syncedSettings.eventTypes instanceof Array && syncedSettings.eventTypes.length)) delete syncedSettings.eventTypes;
    ...
    if (syncedSettings.referenceLines) {
        if (!(syncedSettings.referenceLines instanceof Array)) syncedSettings.referenceLines = [syncedSettings.referenceLines];

        syncedSettings.referenceLines = syncedSettings.referenceLines.map(function (referenceLine) {
...
function backButton() {
    ...
    }).selectAll('select,input').property('disabled', false);
...
function onLayout() {
    ...
    topXaxis.append('text').classed('axis-title top', true).text('Study Day');
...
function listing(clinicalTimelines) {
    var listing = webcharts.createTable(clinicalTimelines.element, clinicalTimelines.config.listingConfig || {
