...
function defineStyles() {
    ...
    //Annotations
    '#clinical-timelines #ct-left-column .ct-annotation {' + '    font-size: 90%;' + '    text-align: right;' + '}', '#clinical-timelines #ct-left-column .ct-annotation .ct-stats,' + '#clinical-timelines #ct-left-column .ct-annotation .ct-characteristic span {' + '    font-weight: bold;' + '}', '#clinical-timelines #ct-left-column .ct-annotation .ct-stats.ct-sample {' + '    color: green;' + '}', '#clinical-timelines #ct-left-column .ct-annotation .ct-stats.ct-sample-inside-time-range {' + '    color: blue;' + '}', '#clinical-timelines #ct-left-column .ct-annotation .ct-stats.ct-sample-outside-time-range {' + '    color: red;' + '}', '#clinical-timelines #ct-left-column .ct-annotation .ct-info-icon {' + '    font-weight: bold;' + '    color: blue;' + '    cursor: help;' + '}',

    //Controls
    '#clinical-timelines #ct-left-column .wc-controls {' + '    margin-bottom: 0;' + '    clear: left;' + '}', '#clinical-timelines #ct-left-column .wc-controls .control-group {' + '    margin: 0 0 5px 0;' + '    display: block;' + '    float: right;' + '    clear: both;' + '    width: 100%;' + '}', '#clinical-timelines #ct-left-column .wc-controls .ct-horizontal-rule {' + '    width: 100%;' + '    display: inline-block;' + '    margin-bottom: 5px;' + '    font-size: 150%;' + '    border-bottom: 1px solid black;' + '}', '#clinical-timelines #ct-left-column .wc-controls .control-group.ct-ID {' + '    display: inline-block;' + '}', '#clinical-timelines #ct-left-column .wc-controls .control-group > * {' + '    display: inline-block;' + '    vertical-align: top;' + '    float: right;' + '}', '#clinical-timelines #ct-left-column .wc-controls .control-group .span-description {' + '    font-size: 90%;' + '}', '#clinical-timelines #ct-left-column .wc-controls .control-group .changer {' + '    margin-left: 5px;' + '    width: 50%;' + '    clear: right;' + '    box-sizing: border-box;' + '}', '#clinical-timelines #ct-left-column #ct-ID-details #ct-back-button {' + '    display: inline-block;' + '    float: left;' + '}', '#clinical-timelines #ct-left-column #ct-ID-details #ct-back-button button {' + '    padding: 0 5px;' + '    font-size: 110%;' + '}',
...
function defineLayout() {
    ...
    this.containers.leftColumn = this.containers.main.append('div').classed('ct-column', true).attr('id', 'ct-left-column'), this.containers.details = this.containers.leftColumn.append('div').attr('id', 'ct-details');

    //Add container for population details.
    this.containers.populationDetails = this.containers.details.append('div').classed('ct-annotation', true).attr('id', 'ct-population-details');

    //Add container for ID characteristics.
    this.containers.IDdetails = this.containers.details.append('div').classed('ct-annotation ct-hidden', true).attr('id', 'ct-ID-details');

    //Add back button to return from ID timeline to clinical timelines.
    this.containers.IDdetails.append('div').attr('id', 'ct-back-button').append('button').html('&#8592; Back');
...
function IDdetails() {
    ...
    //Add back button to return from ID timeline to clinical timelines.
    this.clinicalTimelines.containers.IDdetails.select('#ct-back-button button').on('click', function () {
...
function updatePopulationDetails() {
    var sample = '<span class = \'ct-stats ct-sample\'>' + this.populationDetails.n + '</span> of <span class = \'ct-stats\'>' + this.populationDetails.N + '</span> ' + (this.populationDetails.N > 1 ? this.config.id_unitPlural : this.config.id_unit) + ' (<span class = \'ct-stats\'>' + d3$1.format('%')(this.populationDetails.rate) + '</span>) <span class = \'ct-info-icon\' title = \'These ' + this.config.id_unitPlural + ' have data that meet the current filter criteria.\'>&#9432;</span>',
        sampleInsideTimeRange = this.populationDetails.nInsideTimeRange < this.populationDetails.n ? '<span class = \'ct-stats ct-sample-inside-time-range\'>' + this.populationDetails.nInsideTimeRange + '</span> of <span class = \'ct-stats ct-sample\'>' + this.populationDetails.n + '</span> displayed (<span class = \'ct-stats\'>' + d3$1.format('%')(this.populationDetails.rateInsideTimeRange) + '</span>) <span class = \'ct-info-icon\' title = \'These ' + this.config.id_unitPlural + ' have events that occur in the current time range.\'>&#9432;</span>' : '',
        sampleOutsideTimeRange = this.populationDetails.nOutsideTimeRange ? '<span class = \'ct-stats ct-sample-outside-time-range\'>' + this.populationDetails.nOutsideTimeRange + '</span> of <span class = \'ct-stats ct-sample\'>' + this.populationDetails.n + '</span> hidden (<span class = \'ct-stats\'>' + d3$1.format('%')(this.populationDetails.rateOutsideTimeRange) + '</span>) <span class = \'ct-info-icon\' title = \'These ' + this.config.id_unitPlural + ' do not have events that occur in the current time range.\'>&#9432;</span>' : '';

    this.clinicalTimelines.containers.populationDetails.html([sample, sampleInsideTimeRange, sampleOutsideTimeRange].join('</br>'));
}
