...
function defineStyles() {
    ...
    'html {' + '    overflow: -moz-scrollbars-vertical;' + '    overflow-y: scroll;' + '}', '#clinical-timelines {' + '    display: inline-block;' + '    width: 100%;' + '}', '#clinical-timelines .ct-hidden {' + '    display: none !important;' + '}', '#clinical-timelines .ct-button {' + '    cursor: pointer !important;' + '    border-radius: 4px !important;' + '    padding: 5px !important;' + '}', '#clinical-timelines .ct-button.ct-highlighted {' + '    border: 2px solid black !important;' + '}', '#clinical-timelines .ct-button.ct-selected {' + '    background: lightgray;' + '}',
    ...
    //Reference Tables
    '#clinical-timelines #ct-left-column .ct-reference-line-header {' + '    text-align: center;' + '    border-bottom: 1px solid black;' + '    padding-bottom: 5px;' + '}', '#clinical-timelines #ct-left-column .ct-reference-line-table {' + '    width: 100%;' + '    display: table;' + '}', '#clinical-timelines #ct-left-column .ct-reference-line-table th,' + '#clinical-timelines #ct-left-column .ct-reference-line-table td {' + '    text-align: left;' + '}', '#clinical-timelines #ct-left-column .ct-higher-level {' + '    border-bottom: 1px dotted lightgray;' + '    font-weight: bold;' + '    font-size: 14px;' + '}', '#clinical-timelines #ct-left-column .ct-lower-level {' + '    font-size: 12px;' + '}', '#clinical-timelines #ct-left-column .ct-lower-level.ct-indent {' + '    padding-left: 5%;' + '}',
    ...
    //Legend
    '#clinical-timelines #ct-right-column #ct-timelines .wc-chart .legend {' + '    display: flex !important;' + '    justify-content: center;' + '}', '#clinical-timelines #ct-right-column #ct-timelines .wc-chart .legend .legend-title {' + '    border-radius: 4px;' + '    padding: 5px 7px 3px 4px;' + '    border: 2px solid white;' + '    margin-right: .25em !important;' + '}', '#clinical-timelines #ct-right-column #ct-timelines .wc-chart .legend .legend-item {' + '    cursor: pointer;' + '    float: left;' + '    border-radius: 4px;' + '    padding: 4px 7px 3px 4px;' + '    border: 2px solid white;' + '    margin-right: .25em !important;' + '}', '#clinical-timelines #ct-right-column #ct-timelines .wc-chart .legend .legend-item .legend-color-block circle {' + '    cx: .55em !important;' + '    cy: .55em !important;' + '    r: .4em !important;' + '}', '#clinical-timelines #ct-right-column #ct-timelines .wc-chart .legend .legend-item:hover {' + '    border: 2px solid black;' + '}',
    ...
    //Lines
    '#clinical-timelines path.wc-data-mark {' + '    stroke-width: 6;' + '    stroke-opacity: 1;' + '}', '#clinical-timelines path.wc-data-mark.ct-highlighted {' + '    stroke-width: 9;' + '}', '#clinical-timelines line.ct-highlight-overlay {' + '    clip-path: url(#1);' + '    stroke-width: 3;' + '    stroke-linecap: round;' + '}',

    //Circles
    '#clinical-timelines circle.wc-data-mark {' + '    stroke-width: 0;' + '    fill-opacity: 1;' + '}', '#clinical-timelines circle.wc-data-mark.ct-highlighted {' + '    stroke-opacity: 1;' + '    stroke-width: 3;' + '}',

    //Arrows
    '#clinical-timelines polygon.ct-ongoing-event {' + '    clip-path: url(#1);' + '}', '#clinical-timelines polygon.ct-ongoing-event.ct-highlighted {' + '    stroke-width: 3;' + '}',

    //Reference lines
    '#clinical-timelines #ct-right-column .wc-chart .wc-svg .ct-visible-reference-line {' + '    stroke: black;' + '    stroke-width: 1;' + '    stroke-dasharray: 2,2;' + '}', '#clinical-timelines #ct-right-column .wc-chart .wc-svg .ct-visible-reference-line.ct-hover {' + '    stroke-dasharray: none;' + '}', '#clinical-timelines #ct-right-column .wc-chart .wc-svg .ct-invisible-reference-line {' + '    cursor: pointer;' + '    stroke: black;' + '    stroke-width: 20;' + '    stroke-opacity: 0;' + '}', '#clinical-timelines #ct-right-column .wc-chart .wc-svg .reference-line-text {' + '    font-weight: bold;' + '    font-size: 24px;' + '}',
...
function defineLayout() {
    ...
    this.containers.exportButton = this.containers.populationDetails.append('div').classed('ct-details-button', true).attr('id', 'ct-export-button').append('a').html('&dArr; Data');
    ...
    this.containers.backButton = this.containers.IDdetails.append('div').classed('ct-details-button', true).attr('id', 'ct-back-button').append('a').html('&lArr; Back');
...
function IDdetails() {
    ...
    this.clinicalTimelines.containers.backButton.on('click', function () {
...
function exportData() {
    ...
    var data = this.wideDataInsideTimeRange.filter(function (d) {
        var st = _this.config.time_function(d[_this.config.st_col]),
            en = _this.config.time_function(d[_this.config.en_col]),
            stInsideTimeRange = _this.config.x.domain[0] <= st && st <= _this.config.x.domain[1],
            // start is within the time range
        ...
        variables = this.clinicalTimelines.settings.id_characteristics.concat(this.clinicalTimelines.settings.details.filter(function (detail) {
        return _this.clinicalTimelines.settings.id_characteristics.map(function (id_characteristic) {
    ...
    overlapping.forEach(function (d) {
        ...
        d.values.keys.forEach(function (di, i) {
            ...
            var className = di + ' point',
                g = _this.clinicalTimelines.test ? d3$1.select(_this.clinicalTimelines.dom.window.document.getElementsByClassName(className)[0]) : d3$1.select(document.getElementsByClassName(className)[0]),
            ...
            overlappingLines.forEach(function (currentLine, i) {
                ...
                if (currentLine.offset > 0) {
                    ...
                    var className = currentLine.key + ' line',
                        g = _this.clinicalTimelines.test ? d3$1.select(_this.clinicalTimelines.dom.window.document.getElementsByClassName(className)[0]) : d3$1.select(document.getElementsByClassName(className)[0]);
                    g.attr('transform', 'translate(0,' + currentLine.offset * +mark.attributes['stroke-width'] * 1.5 + ')');
                } else {
                    //Capture line via its class name and offset vertically.
                    var _className = currentLine.key + ' line',
                        _g = _this.clinicalTimelines.test ? d3$1.select(_this.clinicalTimelines.dom.window.document.getElementsByClassName(_className)[0]) : d3$1.select(document.getElementsByClassName(_className)[0]);
...
function highlightMarks() {
    ...
    paths.each(function (d, i) {
        var g = d3$1.select(this.parentNode),
            ...
            y = context.y(d.values[0].values.raw[0][context.config.y.column === context.config.id_col ? context.config.id_col : context.config.seq_col]) + context.y.rangeBand() / 2,
            color = context.config.event_highlight_color,
            line = g.append('line').classed('ct-highlight-overlay', true).attr({
            x1: x1,
            x2: x2,
            y1: y,
            y2: y,
        ...
        if (d.ongoing === context.config.ongo_val) {
            var arrow = [[x2 + 7, y], [x2, y - 2.5], [x2, y + 2.5]],
                polygon = g.append('polygon').datum(d).classed('ct-highlighted ct-ongoing-event', true).attr({
...
function drawOngoingMarks() {
    ...
    if (this.raw_data.length && this.raw_data[0].hasOwnProperty(this.config.ongo_col)) {
        ...
        this.svg.selectAll('.line-supergroup .line').filter(function (d) {
            ...
            g.append('polygon').datum(d).classed('ct-ongoing-event', true).attr({
                points: arrow.map(function (coordinate) {
                    return coordinate.join(',');
                }).join(' '),
                fill: color,
...
function addInvisibleLine(reference_line) {
    reference_line.invisibleLine = reference_line.g.append('line').datum(reference_line.lineDatum).classed('ct-invisible-reference-line', true).attr({
        x1: function x1(d) {
            return d.x1;
        },
        x2: function x2(d) {
...
function addHover(reference_line) {
    ...
    reference_line.invisibleLine.on('mouseover', function () {
...
function drawReferenceTable(reference_line, i) {
    ...
    reference_line.table = reference_line.tableContainer.append('table').classed('ct-reference-line-table', true).append('tbody');
