...
function defineStyles() {
    ...
    //Mark highlighting
    '#clinical-timelines path.highlighted {' + '    stroke: black;' + '}', '#clinical-timelines line.highlight-overlay {' + '    stroke-width: 2px;' + '}', '#clinical-timelines circle.highlighted {' + '    stroke: black;' + '    stroke-width: 2px;' + '}', '#clinical-timelines polygon.highlighted {' + '    stroke: black;' + '    stroke-width: 2px;' + '}',
    ...
    //Y-axis
    '#clinical-timelines > #right-side > .wc-chart .wc-svg .y.axis .tick {' + '    cursor: pointer;' + '    fill: blue;' + '    text-decoration: underline;' + '}', '#clinical-timelines > #right-side > .wc-chart .wc-svg .y.axis .tick rect.ct-stripe {' + '    stroke: #aaa;' + '    stroke-width: 2;' + '    fill: #eee;' + '}',
...
function highlightMarks() {
    ...
    var highlightedMarks = this.svg.selectAll('.wc-data-mark, .ongoing-event').classed('highlighted', function (d) {
        ...
        var g = d3.select(this.parentNode),
            ...
            y1: context.y(d.values[0].values.raw[0][context.config.id_col]) + context.y.rangeBand() / 2,
            y2: context.y(d.values[0].values.raw[0][context.config.id_col]) + context.y.rangeBand() / 2,
...
function onResize() {
    ...
    var yAxisGridLines = this.svg.selectAll('.y.axis .tick').each(function (d, i) {
        ...
        if (i % 2 - 1) d3.select(this).insert('rect', ':first-child').classed('ct-stripe', true).attr({
            id: d,
