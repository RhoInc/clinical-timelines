...
function defineStyles() {
    ...
    //buttons
    '#clinical-timelines .ct-button {' + '    display: inline-block;' + '    border: 2px solid black !important;' + '    border-radius: 4px !important;' + '    color: #333;' + '    background: #ccc;' + '    cursor: pointer !important;' + '}', '#clinical-timelines .ct-button:hover {' + '    color: #ccc;' + '    background: #333 !important;' + '}',
    ...
    //Select All button
    '#clinical-timelines #ct-right-column #ct-timelines .ct-select-all {' + '    position: relative;' + '    z-index: 2;' + '    float: right;' + '    font-size: 110%;' + '    font-weight: bold;' + '    padding: 2px 5px !important;' + '    color: blue;' + '    text-decoration: none;' + '}', '#clinical-timelines #ct-right-column #ct-timelines .ct-select-all:hover {' + '    color: #ccc;' + '}', '#clinical-timelines #ct-right-column #ct-timelines .wc-chart {' + '    position: relative;' + '    z-index: 1;' + '}',
...
function defineLayout() {
    ...
    this.containers.backButton = this.containers.IDdetails.append('div').classed('ct-button', true).attr('id', 'ct-back-button').append('a').html('&lArr; Back to Timelines').on('click', function () {
    ...
    this.containers.controls.append('div').classed('ct-button ct-reset', true).text('Reset Controls').on('click', function () {
    ...
    //Add button that selects all event types.
    this.containers.timelines.append('div').classed('ct-button ct-select-all', true).text('Select All Event Types').on('click', function () {
...
function controlGroupLayout() {
    ...
    this.controls.wrap.selectAll('.control-group').each(function (d) {
        ...
        if (d.value_col === context.config.id_col) context.controls.wrap.insert('div', ':first-child').classed('ct-controls ct-horizontal-rule', true).text('Controls');else if (context.config.groupings.length && d.option === 'y.grouping' || !context.config.groupings.length && d.option === 'y.sort') {
            var filterRule = context.controls.wrap.append('div').classed('ct-filters ct-horizontal-rule', true).text('Filters');
