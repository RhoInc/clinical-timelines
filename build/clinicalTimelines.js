...
function defineStyles() {
    ...
    '#clinical-timelines {' + '    display: inline-block;' + '    width: 100%;' + '}', '#clinical-timelines .hidden {' + '    display: none !important;' + '}', '#clinical-timelines .ct-button {' + '    cursor: pointer !important;' + '    border-radius: 4px !important;' + '    padding: 5px !important;' + '}', '#clinical-timelines .ct-button.highlighted {' + '    border: 2px solid black !important;' + '}', '#clinical-timelines .ct-button.selected {' + '    background: lightgray;' + '}',

    /***--------------------------------------------------------------------------------------\
      Left and right side containers
    \--------------------------------------------------------------------------------------***/

    '#clinical-timelines > * {' + '    display: inline-block;' + '}', '#clinical-timelines > #left-side {' + '    width: 22%;' + '    float: left;' + '}', '#clinical-timelines > #right-side {' + '    width: 75%;' + '    float: right;' + '}', '#clinical-timelines > * > * {' + '    width: 100%;' + '    vertical-align: top;' + '    display: inline-block;' + '    margin-bottom: 10px;' + '}',

    /***--------------------------------------------------------------------------------------\
      Left side container elements
    \--------------------------------------------------------------------------------------***/

    '#clinical-timelines > #left-side > * {' + '    border: 1px solid #eee;' + '    padding: 10px;' + '}',

    //Annotations
    '#clinical-timelines > #left-side > .annotation {' + '    font-size: 90%;' + '    text-align: right;' + '}', '#clinical-timelines > #left-side > .annotation .ct-stats,' + '#clinical-timelines > #left-side > .annotation #ID,' + '#clinical-timelines > #left-side > .annotation .characteristic span {' + '    font-weight: bold;' + '}', '#clinical-timelines > #left-side > .annotation .ct-stats.sample {' + '    color: green;' + '}', '#clinical-timelines > #left-side > .annotation .ct-stats.sample-inside-time-range {' + '    color: blue;' + '}', '#clinical-timelines > #left-side > .annotation .ct-stats.sample-outside-time-range {' + '    color: red;' + '}', '#clinical-timelines > #left-side > .annotation .ct-info-icon {' + '    font-weight: bold;' + '    color: blue;' + '    cursor: help;' + '}',

    //Controls
    '#clinical-timelines > #left-side > .wc-controls {' + '    clear: left;' + '}', '#clinical-timelines > #left-side > .wc-controls .control-group {' + '    margin: 0 0 5px 0;' + '    display: block;' + '    float: right;' + '    clear: both;' + '    width: 100%;' + '}', '#clinical-timelines > #left-side > .wc-controls .horizontal-rule {' + '    width: 100%;' + '    display: inline-block;' + '    margin-bottom: 5px;' + '    font-size: 150%;' + '    border-bottom: 1px solid black;' + '}', '#clinical-timelines > #left-side > .wc-controls .control-group.ID {' + '    display: inline-block;' + '}', '#clinical-timelines > #left-side > .wc-controls .control-group > * {' + '    display: inline-block;' + '    vertical-align: top;' + '    float: right;' + '}', '#clinical-timelines > #left-side > .wc-controls .control-group .span-description {' + '    font-size: 90%;' + '}', '#clinical-timelines > #left-side > .wc-controls .control-group .changer {' + '    margin-left: 5px;' + '    width: 50%;' + '    clear: right;' + '    box-sizing: border-box;' + '}', '#clinical-timelines > #left-side > .ID-details .back-button {' + '    display: inline-block;' + '    float: left;' + '}', '#clinical-timelines > #left-side > .ID-details .back-button button {' + '    padding: 0 5px;' + '    font-size: 110%;' + '}',

    //Reference Tables
    '#clinical-timelines > #left-side .poe-reference-line-header {' + '    text-align: center;' + '    border-bottom: 1px solid black;' + '    padding-bottom: 5px;' + '}', '#clinical-timelines > #left-side .poe-reference-line-table {' + '    width: 100%;' + '    display: table;' + '}', '#clinical-timelines > #left-side .poe-reference-line-table th,' + '#clinical-timelines > #left-side .poe-reference-line-table td {' + '    text-align: left;' + '}', '#clinical-timelines > #left-side .poe-higher-level {' + '    border-bottom: 1px dotted lightgray;' + '    font-weight: bold;' + '    font-size: 14px;' + '}', '#clinical-timelines > #left-side .poe-lower-level {' + '    font-size: 12px;' + '}', '#clinical-timelines > #left-side .poe-lower-level.poe-indent {' + '    padding-left: 5%;' + '}',
    ...
    //Legend
    '#clinical-timelines > #right-side > .wc-chart .legend {' + '    display: flex !important;' + '    justify-content: center;' + '}', '#clinical-timelines > #right-side > .wc-chart .legend .legend-title {' + '    border-radius: 4px;' + '    padding: 5px 7px 3px 4px;' + '    border: 2px solid white;' + '    margin-right: .25em !important;' + '}', '#clinical-timelines > #right-side > .wc-chart .legend .legend-item {' + '    cursor: pointer;' + '    float: left;' + '    border-radius: 4px;' + '    padding: 4px 7px 3px 4px;' + '    border: 2px solid white;' + '    margin-right: .25em !important;' + '}', '#clinical-timelines > #right-side > .wc-chart .legend .legend-item .legend-color-block circle {' + '    cx: .55em !important;' + '    cy: .55em !important;' + '    r: .4em !important;' + '}', '#clinical-timelines > #right-side > .wc-chart .legend .legend-item:hover {' + '    border: 2px solid black;' + '}',

    //Y-axis
    '#clinical-timelines > #right-side > .wc-chart .wc-svg .y.axis .tick {' + '    cursor: pointer;' + '    fill: blue;' + '    text-decoration: none;' + '    font-weight: bolder;' + '}', '#clinical-timelines > #right-side > .wc-chart .wc-svg .y.axis .tick:hover {' + '    text-decoration: underline;' + '}', '#clinical-timelines > #right-side > .wc-chart .wc-svg .y.axis .tick rect.ct-stripe {' + '    stroke: #aaa;' + '    stroke-width: 1;' + '    fill: none;' + '}', '#clinical-timelines > #right-side > .wc-chart .wc-svg .y.axis .tick:nth-child(even) rect.ct-stripe {' + '    fill: #eee;' + '}',

    //Grouping
    '#clinical-timelines > #right-side > .wc-chart .wc-svg .grouping .boundary {' + '    stroke: black;' + '    stroke-width: 2;' + '}', '#clinical-timelines > #right-side > .wc-chart .wc-svg .grouping .annotation {' + '    font-size: 150%;' + '    font-weight: normal;' + '    text-anchor: start;' + '}', '#clinical-timelines > #right-side > .wc-chart .wc-svg .grouping.vertical .annotation {' + '    writing-mode: tb-rl;' + '}',

    //Lines
    '#clinical-timelines path.wc-data-mark {' + '    stroke-width: 6;' + '    stroke-opacity: 1;' + '}', '#clinical-timelines path.wc-data-mark.highlighted {' + '    stroke-width: 9;' + '}', '#clinical-timelines line.highlight-overlay {' + '    stroke-width: 3;' + '    stroke-linecap: round;' + '}',

    //Circles
    '#clinical-timelines circle.wc-data-mark {' + '    stroke-width: 0;' + '    fill-opacity: 1;' + '}', '#clinical-timelines circle.wc-data-mark.highlighted {' + '    stroke-opacity: 1;' + '    stroke-width: 3;' + '}',

    //Arrows
    '#clinical-timelines polygon.ongoing-event {' + '}', '#clinical-timelines polygon.ongoing-event.highlighted {' + '    stroke-width: 3;' + '}',

    //Reference lines
    '#clinical-timelines .wc-chart .wc-svg title {' + '    white-space: pre;' + '}', '#clinical-timelines > #right-side .wc-chart .wc-svg .visible-reference-line {' + '    stroke: black;' + '    stroke-width: 2;' + '    stroke-dasharray: 2,2;' + '}', '#clinical-timelines > #right-side .wc-chart .wc-svg .visible-reference-line.hover {' + '    stroke-dasharray: none;' + '}', '#clinical-timelines > #right-side .wc-chart .wc-svg .invisible-reference-line {' + '    cursor: pointer;' + '    stroke: black;' + '    stroke-width: 20;' + '    stroke-opacity: 0;' + '}', '#clinical-timelines > #right-side .wc-chart .wc-svg .reference-line-label {' + '}', '#clinical-timelines > #right-side .wc-chart .wc-svg .reference-line-label-box {' + '    fill: white;' + '    stroke: black;' + '    stroke-width: black;' + '}',

    //ID timeline
    '#clinical-timelines > #right-side > .wc-small-multiples .wc-chart {' + '    width: 100%;' + '    padding: 0;' + '    border-top: 1px solid black;' + '}', '#clinical-timelines > #right-side > .wc-small-multiples .wc-chart > * {' + '    display: inline-block;' + '}', '#clinical-timelines > #right-side > .wc-small-multiples .wc-chart .wc-svg {' + '    float: left;' + '    width: 75%;' + '}', '#clinical-timelines > #right-side > .wc-small-multiples .wc-chart .wc-chart-title {' + '    float: right;' + '    text-align: left;' + '    font-size: 150%;' + '    font-weight: normal;' + '    padding-left: 10px;' + '    width: 24%;' + '}', '#clinical-timelines > #right-side > .wc-small-multiples .wc-chart .wc-svg .time-range {' + '    opacity: .1;' + '}',

    //Listing
    '#clinical-timelines > #right-side > .wc-chart.wc-table table {' + '    display: table;' + '    width: 100%;' + '}'],
...
function syncRendererSpecificSettings(settings) {
    ...
    if (settings.reference_lines) {
        ...
        settings.reference_lines = settings.reference_lines.map(function (reference_line) {
            ...
            referenceLineObject.label = reference_line.label ? reference_line.label : referenceLineObject.time_scale + ': ' + referenceLineObject.timepoint;
...
function updateIDfilter() {
    ...
    }).selectAll('option').property('selected', function (option) {
...
function detailsLayout() {
    ...
    this.populationDetails.wrap = this.leftSide.insert('div', ':first-child').classed('annotation population-details', true);

    //Add container for ID characteristics.
    this.IDdetails.wrap = this.leftSide.insert('div', ':first-child').classed('annotation ID-details hidden', true);
    this.IDdetails.wrap.selectAll('div.characteristic').data(this.config.id_characteristics).enter().append('div').classed('characteristic', true).html(function (d) {
        return d.label + ': <span id = \'' + d.value_col + '\'></span>';
    });

    //Add back button to return from ID timeline to clinical timelines.
    this.backButton = this.IDdetails.wrap.insert('div', ':first-child').classed('back-button hidden', true);
    this.backButton.append('button').html('&#8592; Back').on('click', function () {
...
function controlGroupLayout() {
    ...
    this.controls.wrap.selectAll('.control-group').each(function (d) {
        ...
        if (d.value_col === context.config.id_col) context.controls.wrap.insert('div', ':first-child').classed('controls horizontal-rule', true).text('Controls');else if (d.option === 'y.grouping') {
            var filterRule = context.controls.wrap.append('div').classed('filters horizontal-rule', true).text('Filters');
...
function drawIDtimeline() {
    ...
    this.listing.draw(wideIDdata.filter(function (d) {
        return _this.currentEventTypes !== 'All' ? _this.currentEventTypes.indexOf(d[_this.config.event_col]) > -1 : true;
    }));
}
...
function timeRangeControl(datum) {
    var context = this,
        timeRangeContainer = this.controls.wrap.insert('div', '#control-y-sort').datum(datum).classed('control-group time-range ct-control', true).attr('id', function (d) {
        return 'control-' + d.option.replace(/\./g, '-');
    }),
        timeRangeInput = timeRangeContainer.append('input').classed('changer', true),
        timeRangeLabelDescription = timeRangeContainer.append('div').classed('label-description', true);
...
function updatePopulationDetails() {
    var sample = '<span class = \'ct-stats sample\'>' + this.populationDetails.n + '</span> of <span class = \'ct-stats\'>' + this.populationDetails.N + '</span> ' + (this.populationDetails.N > 1 ? this.config.id_unitPlural : this.config.id_unit) + ' (<span class = \'ct-stats\'>' + d3$1.format('%')(this.populationDetails.rate) + '</span>) <span class = \'ct-info-icon\' title = \'These ' + this.config.id_unitPlural + ' have data that meet the current filter criteria.\'>&#9432;</span>',
        sampleInsideTimeRange = this.populationDetails.nInsideTimeRange < this.populationDetails.n ? '<span class = \'ct-stats sample-inside-time-range\'>' + this.populationDetails.nInsideTimeRange + '</span> of <span class = \'ct-stats sample\'>' + this.populationDetails.n + '</span> displayed (<span class = \'ct-stats\'>' + d3$1.format('%')(this.populationDetails.rateInsideTimeRange) + '</span>) <span class = \'ct-info-icon\' title = \'These ' + this.config.id_unitPlural + ' have events that occur in the current time range.\'>&#9432;</span>' : '',
        sampleOutsideTimeRange = this.populationDetails.nOutsideTimeRange ? '<span class = \'ct-stats sample-outside-time-range\'>' + this.populationDetails.nOutsideTimeRange + '</span> of <span class = \'ct-stats sample\'>' + this.populationDetails.n + '</span> hidden (<span class = \'ct-stats\'>' + d3$1.format('%')(this.populationDetails.rateOutsideTimeRange) + '</span>) <span class = \'ct-info-icon\' title = \'These ' + this.config.id_unitPlural + ' do not have events that occur in the current time range.\'>&#9432;</span>' : '';

    this.populationDetails.wrap.html([sample, sampleInsideTimeRange, sampleOutsideTimeRange].join('</br>'));
}
...
function legendFilter() {
    ...
    eventTypes = eventTypeControl.selectAll('.changer option').sort(function (a, b) {
        ...
        // event type options
    legendItems = this.wrap.selectAll('.legend-item').classed('ct-button', true).classed('selected', function (d) {
...
function tickClick() {
    ...
    this.svg.selectAll('.y.axis .tick').each(function (d) {
        ...
        //Highlight ID dropdown.
        _this.controls.wrap.selectAll('.control-group').filter(function (control) {
            return control.value_col === _this.config.id_col;
        }).style({
            'font-weight': 'bold'
        }).transition().delay(500).style({
    ...
    this.groupings.sort(function (a, b) {
        ...
        if (d.IDs.length) {
            var nIDs = d.IDs.length,
                ...
                y1 = _this.y(firstID),
                y2 = _this.y(d.IDs[0]),
                g = _this.svg.append('g').classed('grouping horizontal', true).attr('id', d.key.replace(/ /g, '-')),
                annotation = g.append('text').classed('annotation', true).attr({
                x: 0,
                y: y1,
                ...
                rule = g.append('line').classed('boundary horizontal', true).attr({
                x1: 0,
    ...
    this.groupings.forEach(function (d) {
        if (d.IDs.length) {
            var nIDs = d.IDs.length,
                ...
                y1 = _this.y(firstID),
                y2 = _this.y(d.IDs[0]),
                g = _this.svg.append('g').classed('grouping vertical', true).attr('id', d.key.replace(/ /g, '-')),
                topBoundary = g.append('line').classed('boundary horizontal', true).attr({
                x1: _this.plot_width,
                x2: _this.plot_width + _this.margin.right / 8,
                y1: y1 + 3 * _this.y.rangeBand() / 4,
                y2: y1 + 3 * _this.y.rangeBand() / 4
            }),
                span = g.append('line').classed('boundary vertical', true).attr({
                x1: _this.plot_width + _this.margin.right / 8,
                x2: _this.plot_width + _this.margin.right / 8,
                y1: y1 + 3 * _this.y.rangeBand() / 4,
                y2: y2 + _this.y.rangeBand()
            }),
                bottomBoundary = g.append('line').classed('boundary horizontal', true).attr({
                x1: _this.plot_width,
                x2: _this.plot_width + _this.margin.right / 8,
...
function addStriping() {
    ...
    var yAxisGridLines = this.svg.selectAll('.y.axis .tick').each(function (d, i) {
        d3$1.select(this).select('text').attr('dy', context.y.rangeBand() / 2);
        d3$1.select(this).insert('rect', ':first-child').attr({
            id: d,
            ...
            overlappingLines.forEach(function (currentLine, i) {
                ...
                if (currentLine.offset > 0) {
                    ...
                    var _className = currentLine.key + ' line',
                        _g = d3$1.select(document.getElementsByClassName(_className)[0]);
...
function highlightMarks() {
    ...
    //Select marks.
    var highlightedMarks = this.svg.selectAll('.wc-data-mark, .ongoing-event').classed('highlighted', function (d) {
    ...
    paths.each(function (d, i) {
        var g = d3$1.select(this.parentNode),
            ...
            line = g.append('line').classed('highlight-overlay', true).attr({
            x1: x1,
            x2: x2,
            y1: y,
            y2: y,
        ...
        if (d.ongoing === context.config.ongo_val) {
            var arrow = [[x2 + 7, y], [x2, y - 2.5], [x2, y + 2.5]],
                polygon = g.append('polygon').datum(d).classed('highlighted ongoing-event', true).attr({
...
function drawOngoingMarks() {
    ...
    if (this.raw_data.length && this.raw_data[0].hasOwnProperty(this.config.ongo_col)) {
        ...
        this.svg.selectAll('.line-supergroup .line').filter(function (d) {
            ...
            g.append('polygon').datum(d).classed('ongoing-event', true).attr({
                points: arrow.map(function (coordinate) {
                    return coordinate.join(',');
                }).join(' '),
                fill: color,
...
function addHover(reference_line) {
    ...
    reference_line.invisibleLine.on('click', function () {
        var mouse = d3.mouse(this);
    }).on('mouseover', function () {
        var mouse = d3.mouse(this);
        reference_line.visibleLine.classed('hover', true);
        reference_line.textLabel.classed('hidden', false).attr('y', mouse[1]);
        reference_line.textBox.classed('hidden', false).attr('y', mouse[1] - reference_line.textDimensions.height);
...
function addDrag(reference_line) {
    var drag = d3$1.behavior.drag().origin(function (d) {
        console.log(d);
        return d;
...
function drawReferenceLine(reference_line, i) {
    reference_line.g = this.referenceLinesGroup.append('g').classed('reference-line', true).attr('id', 'reference-line-' + i);
    ...
    }, reference_line.visibleLine = reference_line.g.append('line').datum(reference_line.lineDatum).classed('visible-reference-line', true).attr({
        x1: function x1(d) {
            return d.x1;
        },
        x2: function x2(d) {
    ...
    reference_line.invisibleLine = reference_line.g.append('line').datum(reference_line.lineDatum).classed('invisible-reference-line', true).attr({
        x1: function x1(d) {
            return d.x1;
        },
        x2: function x2(d) {
    ...
    reference_line.textLabel = reference_line.g.append('text').classed('reference-line-label', true).attr({
    ...
    reference_line.textBox = reference_line.g.insert('rect', '.reference-line-label').classed('reference-line-label-box', true).attr({
...
function drawReferenceTable(reference_line, i) {
    ...
    reference_line.wide_data = this.filtered_wide_data.filter(function (d) {
        return _this.config.x_parseFormat.parse(d[_this.config.st_col]) <= _this.config.x_parseFormat.parse(reference_line.timepoint) && _this.config.x_parseFormat.parse(d[_this.config.en_col]) >= _this.config.x_parseFormat.parse(reference_line.timepoint);
    });
    ...
    reference_line.container = this.leftSide.append('div').classed('poe-reference-line-table-container', true).attr('id', 'poe-reference-line-table-container-' + i);
    reference_line.container.append('h3').classed('poe-reference-line-header', true).text(reference_line.label);

    //Add reference line table table.
    reference_line.table = reference_line.container.append('table').classed('poe-reference-line-table', true);
...
function drawReferenceLines() {
    ...
    if (this.config.reference_lines) {
        ...
        this.referenceLinesGroup = this.svg.insert('g', '#clinical-timelines .wc-chart .wc-svg .line-supergroup').classed('reference-lines', true);
        ...
        this.config.reference_lines.filter(function (reference_line) {
            ...
            drawReferenceTable.call(_this, reference_line, i);
        });
    }
}

function IEsucks() {
    if (!!document.documentMode) this.svg.selectAll('.line,.point').each(function (d) {
...
function drawTimeRange() {
    ...
    var x_dom = this.x_dom.map(function (x) {
        ...
        timeRange = this.parent.clinicalTimelines.config.time_scale === 'day' ? this.parent.clinicalTimelines.day_range : this.parent.clinicalTimelines.date_range.map(function (dt) {
        return dt.getTime();
    }),
        timeRangeText = this.config.time_scale === 'day' ? this.parent.clinicalTimelines.day_range.map(function (dy) {
        return dy.toString();
    }) : this.parent.clinicalTimelines.date_range.map(function (dt) {
        return d3$1.time.format(_this.parent.clinicalTimelines.config.date_format)(dt);
    ...
    timeRange[0] <= x_dom[0] && timeRange[1] >= x_dom[1]) // time range fully encompassed x-domain
            ...
            var timeRangeGroup = this.svg.insert('g', '#clinical-timelines .wc-chart .wc-svg .line-supergroup').classed('time-range', true),
                x = this.x(Math.max(timeRange[0], x_dom[0])),
                width = Math.min(this.x(timeRange[1]) - x, this.plot_width - x),
                timeRangeRect = timeRangeGroup.append('rect').classed('time-range-rect', true).attr({
                x: x,
                y: 0,
                width: width,
                height: this.plot_height
            }),
                timeRangeTooltip = timeRangeGroup.append('title').text(this.parent.clinicalTimelines.config.x.label + ' Range: ' + timeRangeText.join(' - '));
        }
}
...
function IDtimeline(clinicalTimelines) {
    var IDtimeline = webcharts.createChart(clinicalTimelines.rightSide.node(), clinicalTimelines.config.IDtimelineSettings);
...
function listing(clinicalTimelines) {
    var listing = webcharts.createTable(clinicalTimelines.rightSide.node(), clinicalTimelines.config.details_config);
...
function clinicalTimelines() {
    ...
    var mergedSettings = merge$1({}, defaults$1.settings, settings),
        ...
        controls = webcharts.createControls(leftSide.node(), { location: 'top', inputs: syncedControls }),
