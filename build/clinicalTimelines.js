...
function timeScaleChange(dropdown, d) {
    ...
    this.IDtimeline.multiples.forEach(function (multiple) {
        multiple.config.time_scale = _this.config.time_scale;
...
function IDtimeline(clinicalTimelines) {
    ...
    webcharts.multiply(IDtimeline, [], clinicalTimelines.config.event_col);
